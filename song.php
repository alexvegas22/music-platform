...
<body>
    <div class="song-box">
        ...
        <div class= "row">
        <img src="https://img.icons8.com/ios-filled/50/null/skip-to-start--v3.png"/>
        <img src="https://img.icons8.com/ios-filled/50/null/play--v2.png"/>
        <img src="https://img.icons8.com/ios-filled/50/null/end--v1.png"/>
        </div>
    </div>
    <audio controls>
  
  <source src="Inna pad.wav" type="audio/x-wav">
